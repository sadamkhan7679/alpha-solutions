...
export const ServicesGrid = ({
  ...
  return (
    <div
      className={cn(
        "grid " +
          "md:auto-rows-max grid-cols-1 md:grid-cols-3 gap-4 max-w-7xl mx-auto ",
        className,
      )}
    >
      {children}
  ...
  return (
    ...
    >
      <CardHeader>
        <CardTitle
          className={cn(
            "flex items-center group-hover:text-white font-bold text-xl service-card-icon",
          )}
        >
          <Icon className="mr-2" width={50} height={40} />
          {title}
        </CardTitle>
      ...
      <CardContent className="mt-auto">
        <div
          // style={{
          //   backgroundImage: `url(${serviceMeta?.image})`,
