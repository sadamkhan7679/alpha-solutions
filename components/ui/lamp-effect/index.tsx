  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
          initial={{ opacity: 0.5, width: widthParams.initial }}
          whileInView={{ opacity: 1, width: widthParams.whileInView }}
          transition={{
            delay: 0.3,
            duration: 0.8,
            ease: "easeInOut",
        ...
        ></motion.div>
        <motion.div
          initial={{ width: widthParams.initial }}
          whileInView={{ width: widthParams.whileInView }}
          transition={{
            delay: 0.3,
            duration: 0.8,
            ease: "easeInOut",
